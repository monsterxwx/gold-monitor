...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('gold-monitor.showUI', () => {
            if (currentPanel) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('gold-monitor.refreshPrice', () => {
            fetchGoldPrice(context);
...
async function fetchGoldPrice(context: vscode.ExtensionContext) {
    try {
...
function updateStatusBar(price: string, rate: string) {
...
async function checkPriceAlerts(context: vscode.ExtensionContext, currentPrice: number) {
    const settings: any = context.globalState.get('settings') || {};
